...
RECT ColoredRect::BoundingBox()
{
	...
	return GameObject::BoundingBox(t, 0, 0);
}

void ColoredRect::LoadResource(LPDIRECT3DDEVICE9 d3ddv, VideoDriver *video){}

void ColoredRect::Update(LPDIRECT3DDEVICE9 d3ddv, DWORD time){}

void ColoredRect::ProcessInput(LPDIRECT3DDEVICE9 d3ddv, int DeltaTime){}